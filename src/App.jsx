  ...
  return (
    <div className="relative min-h-screen overflow-hidden flex flex-col justify-center items-center p-4" 
      ...
      <div className="relative z-20 w-11/12 max-w-3xl py-10 rounded-lg border-8 border-double shadow-2xl p-8 mx-auto my-6"
        ...
        <h1 className="text-6xl font-serif font-bold mb-4 tracking-wide text-center"
            style={{ color: '#E8B25B' }}>
          RANG-E-CHINAR
        </h1>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mt-6">
          {Object.entries(timeLeft).map(([unit, value]) => (
            <div
              key={unit}
              className="p-6 rounded-md text-center transform hover:scale-105 transition duration-300 shadow-lg"
              style={{ 
        ...
        <div className="mt-6 p-6 rounded-md border-4 text-center max-w-lg mx-auto"
          ...
          <div className="flex items-center justify-center gap-3"
            ...
            <span className="text-xl font-serif">4th May 2025</span>
          </div>
          <div className="flex items-center justify-center gap-3 mt-4"
               style={{ color: '#D9AB77' }}>
            <MapPin className="w-8 h-8" />
            <span className="text-xl font-serif">Hazratbal, Srinagar</span>
          </div>
        </div>
      </div>
    </div>
